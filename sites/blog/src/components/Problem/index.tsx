            ...
            headerInfo={{
              ...
              description: (
                <div className="w-full text-adjustment">
                  <p>
                    集客できないほとんどの人がお客に気づかれていません。
                    それは、価値と魅力がズバッと一発でわかる
                    キャッチコピーがないからです。
                  </p>
                  <p>
                    一発で価値が伝わらないキャッチコピーが、こんな問題を引き起こします。
                  </p>
          ...
          <div className="flex flex-wrap items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                ...
                一発でその魅力的が伝われば、 お客があなたの前からいなくなって
                ライバル会社に行ってしまうことはなくなります。
              </p>
              ...
              <h3>あなたの説明をすべて読む義務はない</h3>
              <p>
                あなたの商品が一体何なのか、
                読んでいる人のためになる役立つものなのか、
                一瞬で伝わらなければ読み続けてくれません。
              </p>
              <p>現代社会においては、タイパが最も優先されます。</p>
              <p>
                顔を見たこともないあなたのメッセージを、
                だれも貴重な時間をかけてまで理解しようとしません。
              </p>
              <p>だからこそ、まず</p>
              ...
              <p>
                お客の信用を大切にして、長いお付き合いをする関係になりたいなら、
                掛け値なしの商品の価値をわかりやすく伝えるべきです。
              </p>
              <p>
                そうすれば、商品の値段を際限なく下げ続けることなく、
