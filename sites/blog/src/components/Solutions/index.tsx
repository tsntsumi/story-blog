        ...
        <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
            ...
            headerInfo={{
              ...
              description: (
                <div className="w-full text-adjustment">
                  <p>
                    集客の錬金術では、３つのテンプレートに商品の特徴を当てはめ、
                    売れるキャッチコピーと、売れる仕組みを構築することができます。
                  </p>
                </div>
              )
            }}
          ...
          <div className="mt-7 mx-auto md:w-4/5 lg:w-3/5 xl:w-[46%] text-justify">
            ...
            <p className="text-sm my-2">
              だから、あなたがストーリーで商品を語れば、
              買わせることができます。
            </p>
            <h4>ストーリーなら注目する。それは、生存本能だから</h4>
            <p>
              ようするに、人がストーリーを読むのが好きなのは、
              生き延びるため、いわば生存本能です。
            </p>
            <p>
              人がストーリーを語るのが好きなのは、大衆の行動に影響を与えられるからです。
            </p>
            <p>これは心理学というよりも、生物学の領域です。</p>
            <p>
              言い換えると、あなたがストーリーによるキャッチコピーで、集客したなら、
              大衆の注目を集め、欲しがらせ、買わせることが出来るようになります。
            </p>
            <p>
              つまり、今まで集客できなかったのは、
              ストーリーでキャッチコピーを作っていなかったからなんです。
            </p>
            <p>
              でも、難しい知識も技術も習得する必要はありません。
              だって、あなたの遺伝子にはすでにその能力が備わっているのですから。
            </p>
            <h4>売れた世界的ヒットの法則を真似るだけ</h4>
            <p>例えば、こんなヒット作の構造を真似て作ることができます。</p>
            <ul>
              <li>スターウォーズ</li>
              <li>ロード・オブ・ザ・リング</li>
            ...
            <p>
              ストーリーの構造、骨格、枠組みを意識するだけです。
              薫り高い文学の書き方を学ぶ必要なんてありません。
            </p>
            <p>作者の気持ちはどうだったか、なんて考える必要もありません。</p>
            <p>
              あなたの秘められた能力を、集客の錬金術テンプレートを使って、
              解き放てばいいんです。
            </p>
          </div>
          ...
          <div className="mt-14 mx-auto md:w-4/5 lg:w-3/5 xl:w-[46%] text-justify">
            ...
            <p>
              そして、集客シナリオの錬金術テンプレートで、
              買うべきかどうかというお客の迷いを取り除きます。
            </p>
            <p>
              結果、商品が欲しいという気持ちだけが抽出されます。
              集客の錬金術は、いわばネットの上の買いたい気持ち
              <ruby>
                ろ過装置<rp>(</rp>
                <rt>ファネル</rt>
                <rp>)</rp>
