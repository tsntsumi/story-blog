...
import { OWNER_LOCALE, LOCAL_DATE_OPTIONS, LOCAL_TIME_OPTIONS } from "@/config"
...
export function formatLocalDate(
  ...
  return dateObject.toLocaleDateString(OWNER_LOCALE, {
    ...LOCAL_DATE_OPTIONS,
    ...extraOptions,
  })
}
...
export function formatLocalTime(
  ...
  return dateObject.toLocaleTimeString(OWNER_LOCALE, {
    ...LOCAL_TIME_OPTIONS,
    ...extraOptions,
  })
}
