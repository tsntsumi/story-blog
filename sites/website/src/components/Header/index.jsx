    ...
    <div>
      <a href="/">
        <Image
          ...
          width={256}
          height={64}
          className="hidden min-w-[256px] h-[64px] min-h-[64px] dark:block"
        />
        <Image
          ...
          width={256}
          height={64}
          className="min-w-[256px] h-[64px] min-h-[64px] dark:hidden"
        />
      </a>
    </div>
  )
          ...
          <ul className="flex flex-col gap-5 xl:flex-row xl:items-center xl:gap-10">
            {menuData?.map((menuItem, key) => (
              <li
                key={key}
                className={
                  (menuItem.submenu && "group relative ") + menuItem.attributes
                }
              >
                {menuItem.submenu ? (
                  <>
