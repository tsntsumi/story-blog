...
import Navigation from "@/components/Assets/Header/navigation"
    ...
    <>
      ...
      >
        <div className="relative flex flex-nowarp w-full items-center justify-around gap-2 px-0 py-1 md:px-8">
          <Logo />
          <div className="traking-tighter text-sm whitespace-nowrap font-black text-black m-0 p-0">
            <div>お客さまが</div>
            <div>
              <span className="text-darkgold">主人公</span>
            </div>
          </div>
