  ...
  return (
    <>
      <div className="md:columns-2 gap-8 mt-8">
        ...
        <h2>72時間で ZERO から HERO になってほしい</h2>
        <p>
      ...
      <div className="bg-gold rounded-lg w-3/5 p-2 py-1 mx-auto my-12"></div>
      <div className="md:columns-2 mt-12 pt-8 gap-8 border-t-8">
        <h2 className="rounded-md bg-sky-950 text-gold p-4 mb-8 mt-0">
          え！成約できちゃった？！まだ自信が……
        </h2>
        <p>
